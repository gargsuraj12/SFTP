...
def clientthread(conn, addr): 
    ...
    while True: 
        try: 
            ...
            if message: 
                """prints the message and address of the user who just sent the message on the serverterminal"""
                ...
                """message may have no content if the connection is broken, in this case we remove theconnection"""
                remove(conn) 
...
we broadcast the message to all clients who's object is not the same as the one sending the message """
...
if __name__ == '__main__':
    ...
    while True: 
        ...
        # th.Thread(target=clientthread, args=(conn,addr)).start()
